...
- [x] **X-series complete (2026-05-08, on feature/x-series-detectors)**: X1 extended to `.yaml`/`.yml`; X2 added (undeclared cross-repo import via manifest edges); X3 added (stale GitHub URL in docs). 26 new tests; 1005 total passing. cross_repo config already wired in OC/VF/SB.
