...
| DC | 7 | Doc conventions: design front matter, dead doc refs, ADR naming, README sections, bare-symbol citations, docs/ taxonomy, orphan docs (configurable via `doc_conventions:` block) |
| M | 4 | Repo-meta presence: CHANGELOG.md, CONTRIBUTING.md, SECURITY.md, LICENSE (configurable via `repo_meta.skip:` list) |
